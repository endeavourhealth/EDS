 ...
 *         &lt;element name="Receiver" type="{}HttpReceiver" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class HttpListener {
    ...
    protected List<HttpReceiver> receiver;
     ...
     * 
     */
    public List<HttpReceiver> getReceiver() {
        if (receiver == null) {
            receiver = new ArrayList<HttpReceiver>();
        }
