...
import org.endeavourhealth.hl7test.transform.parser.Helpers;
...
public class MshTransform {
    ...
    public static MessageHeader toFhir(MshSegment source) throws ParseException {
