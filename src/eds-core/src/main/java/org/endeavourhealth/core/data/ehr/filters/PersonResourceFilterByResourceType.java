...
public class PersonResourceFilterByResourceType implements PersonResourceFilter {
    ...
    public PersonResourceFilterByResourceType(UUID personId, String resourceType) {
