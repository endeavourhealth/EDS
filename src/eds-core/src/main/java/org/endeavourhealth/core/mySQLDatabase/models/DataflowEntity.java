...
public class DataflowEntity {
    ...
    private static Short getFlowScheduleId(String flowSchedule) throws Exception {
        switch (flowSchedule.toLowerCase()) {
            case "daily":
                return 0;
            case "on demand":
                return 1;
            default:
                throw new Exception("Invalid Flow Schedule of " + flowSchedule);
        }
    }

    private static String getFlowScheduleText(Integer flowScheduleId) throws Exception {
        switch (flowScheduleId) {
            case 0:
                return "daily";
            case 1:
                return "on demand";
            default:
                throw new Exception("Invalid Flow Schedule Id of " + flowScheduleId.toString());
        }
    }

    private static Short getFlowDirectionId(String flowDirection) throws Exception {
        switch (flowDirection.toLowerCase()) {
            case "inbound":
                return 0;
            case "outbound":
                return 1;
            default:
                throw new Exception("Invalid Flow Direction of " + flowDirection);
        }
    }

    private static String getFlowDirectionText(Integer flowDirectionId) throws Exception {
        switch (flowDirectionId) {
            case 0:
                return "inbound";
            case 1:
                return "outbound";
            default:
                throw new Exception("Invalid Flow Direction Id of " + flowDirectionId.toString());
        }
    }

    private static String getDataExchangeMethodText(Integer dataExchangeMethodId) throws Exception {
        switch (dataExchangeMethodId) {
            case 0:
                return "paper";
            case 1:
                return "electronic";
            default:
                throw new Exception("Invalid Data Exchange Method Id of " + dataExchangeMethodId.toString());
        }
    }

    private static Short getDataExchangeMethodId(String dataExchangeMethod) throws Exception {
        switch (dataExchangeMethod.toLowerCase()) {
            case "paper":
                return 0;
            case "electronic":
                return 1;
            default:
                throw new Exception("Invalid Data Exchange Method of " + dataExchangeMethod);
        }
    }

    private static String getFlowStatusText(Integer flowStatusId) throws Exception {
        switch (flowStatusId) {
            case 0:
            ...
            case 1:
                return "Live";
            default:
                throw new Exception("Invalid Flow Status Id of " + flowStatusId.toString());
        }
    }

    private static Short getFlowStatusId(String flowStatus) throws Exception {
        switch (flowStatus.toLowerCase()) {
            ...
            case "live":
                return 1;
            default:
                throw new Exception("Invalid Flow Status of " + flowStatus);
        }
    }
