...
export class Application {
	...
	public static Define({modules, states}) {
		return {
			imports: [
				BrowserModule,
				FormsModule,
				...
				UIRouterModule.forRoot(<RootModule>{ states: states.concat({name: 'app', url: '/app', component: ShellComponent}), useHash: true, otherwise: { state: 'app.dashboard', params: {} } }),
