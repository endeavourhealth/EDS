export class flowchart {
	...
	public static ruleWidth = 250;
	public static ruleDescriptionHeight = 60;
	public static connectorHeight = 55;

	//
	// Compute the Y coordinate of a connector, given its index.
	//
	public static computeConnectorY = function (connectorIndex) {
	...
	//
	public static computeConnectorPos = function (rule, connectorIndex, inputConnector) {
		return {
	...
	//
	public static StartingRulesViewModel = function (startingRulesDataModel) {
	...
	//
	public static RuleViewModel = function (ruleDataModel) {
	...
	public static createStartingRulesViewModel = function (startingRulesDataModel) {
	...
	public static createRuleViewModel = function (ruleDataModel) {
		var ruleViewModel = [];
	...
	//
	public static ChartViewModel = function (libraryItem) {

		// reference to the libraryItem data
		this.data = libraryItem;

		// create rules view model
		this.rule = flowchart.createRuleViewModel(this.data.query.rule);

		// create startingRules view model
		this.startingRules = flowchart.createStartingRulesViewModel(this.data.query.startingRules.ruleId);
