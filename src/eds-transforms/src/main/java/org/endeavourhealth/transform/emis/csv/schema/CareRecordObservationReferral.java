...
public class CareRecordObservationReferral extends AbstractCsvTransformer {
    public CareRecordObservationReferral(CSVParser csvReader, String dateFormat, String timeFormat) {
