...
public abstract class TerminologyService {
    ...
    public static boolean isRead2Procedure(String code) {
        //TODO - terminology service needs completing
        return false;
    }
    public static boolean isRead2Observation(String code) {
        //TODO - terminology service needs completing
        return false;
    }
    public static boolean isRead2FamilyHistory(String code) {
        //TODO - terminology service needs completing
        return false;
    }
    public static boolean isRead2Condition(String code) {
        //TODO - terminology service needs completing
        return false;
    }
    public static boolean isRead2Allergy(String code) {
        //TODO - terminology service needs completing
        return false;
    }
