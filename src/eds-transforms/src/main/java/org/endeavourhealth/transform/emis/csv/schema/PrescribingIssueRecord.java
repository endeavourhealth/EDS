...
public class PrescribingIssueRecord extends AbstractCsvTransformer {
    public PrescribingIssueRecord(CSVParser csvReader, String dateFormat, String timeFormat) {
