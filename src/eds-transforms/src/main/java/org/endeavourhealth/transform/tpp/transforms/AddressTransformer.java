...
public class AddressTransformer {
    ...
    public static Address tranformWorkAddress(org.endeavourhealth.transform.tpp.schema.Address tppAddress) {
        return tranformAddress(tppAddress, Address.AddressUse.WORK);
    }

    public static Address tranformHomeAddress(org.endeavourhealth.transform.tpp.schema.Address tppAddress) {
        return tranformAddress(tppAddress, Address.AddressUse.HOME);
    }
    public static Address tranformAddress(org.endeavourhealth.transform.tpp.schema.Address tppAddress, Address.AddressUse use) {
