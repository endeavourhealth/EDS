...
public class Xcn extends Datatype implements IXpn {
    ...
    public String getIdentifierCheckDigit() { return this.getComponent(11); }
    public String getIdentifierCheckDigitCodeScheme() { return this.getComponent(12); }
