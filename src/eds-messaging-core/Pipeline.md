...
| Key          | Use      | Description        |
| ------------ | ---      | ------------------ |
| SenderUuid | Mandatory | Sender internal Uuid |
##### Input Body
None
#### Processing
Loads protocols relevant to service (SenderUuid) as a publisher
#### Output Headers
| Key          | Description        |
| ------------ | ------------------ |
| ProtocolIds | List of relevant protocol ids |
| ProtocolData | JSON representation of the relevant protocols themselves |
#### Output Body
Unchanged
