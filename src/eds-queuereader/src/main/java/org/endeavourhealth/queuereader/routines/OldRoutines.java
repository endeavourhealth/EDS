...
public class OldRoutines extends AbstractRoutine {
    private static final Logger LOG = LoggerFactory.getLogger(OldRoutines.class);
     ...
     */
    public static void findMissedExchanges(String tableName, String odsCodeRegex) {
    ...
    public static void createDeleteZipsForSubscriber(int batchSize, String sourceTable, int subscriberId) {
	...
	*/
	...
	public static void testDatabases(String odsCodesStr) {
		...
		try {
			...
			for (String odsCode: odsCodes) {
                ...
                EmisCodeDalI emisCodeDalI = DalProvider.factoryEmisCodeDal();
                EmisClinicalCode codeMap = emisCodeDalI.getClinicalCode(654010L);
				LOG.debug("Publisher common test " + codeMap);

                EmisAdminCacheDalI emisTransformDalI = DalProvider.factoryEmisTransformDal();
				...
				for (String subscriberConfigName: subscriberConfigNames) {
					...
					List<EnterpriseConnector.ConnectionWrapper> subscriberConnections = EnterpriseConnector.openSubscriberConnections(subscriberConfigName);
					for (EnterpriseConnector.ConnectionWrapper subscriberConnection : subscriberConnections) {

                        if (subscriberConnection.hasDatabaseConnection()) {
                            ...
                            LOG.debug("Has no local database");
                        }
					}
				}
...
//LOG.debug("    subscriber config = [" + subscriberConfigName + "]");
     ...
     */
    public static void updatePatientSearch(String filePath) throws Exception {
    ...
    public static void subscriberTransformPatients(String sourceFile, boolean bulkDelete, String reason, Set<String> subscriberConfigNames) {
    ...
    public static void createDigest(String url, String user, String pass, String table, String columnFrom, String columnTo, String base64Salt, String validNhsNumberCol) {
    ...
    /**
     * populates the new DataDate header in Exchanges, so we know WHEN the data was from, not just when it arrived
     */
    /*public static void populateLastDataDate(int threads, int batchSize) {
