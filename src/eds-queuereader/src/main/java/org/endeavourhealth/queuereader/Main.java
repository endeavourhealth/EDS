...
public class Main {
	...
	public static void main(String[] args) throws Exception {
		...
		if (args.length >= 1
				&& args[0].equalsIgnoreCase("SD385fixTppLocalCodes")) {
			...
			SD385.fixTppLocalCodes(includeStartedButNotFinishedServices, testMode, odsCodeRegex);
			System.exit(0);
		}
		...
		if (args.length >= 1
			...
			SD298.fixTppEncounterLinks(includeStartedButNotFinishedServices, testMode, odsCodeRegex);
			System.exit(0);
		}
		...
		if (args.length >= 1
			...
			String odsCodes = args[1];
			OldRoutines.testDatabases(odsCodes);
			System.exit(0);
		}
