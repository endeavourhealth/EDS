...
public class Main {
	...
	public static void main(String[] args) throws Exception {
		...
		if (args.length >= 1
			...
			bulkProcessTransformAndFilePatientsAndEpisodesForProtocolServices(subscriberConfigName, protocolName,
	...
	*/
	...
	private static void bulkProcessTransformAndFilePatientsAndEpisodesForProtocolServices(String subscriberConfigName,
																						  String protocolName,
