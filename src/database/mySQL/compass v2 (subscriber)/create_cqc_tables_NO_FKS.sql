...
CREATE TABLE `abp_address_v2` (
  ...
  `building` varchar(255) COLLATE latin1_bin DEFAULT NULL,
  `number` varchar(255) COLLATE latin1_bin DEFAULT NULL,
  `dependent_thoroughfare` varchar(255) COLLATE latin1_bin DEFAULT NULL,
  `street` varchar(255) COLLATE latin1_bin DEFAULT NULL,
  `dependent_locality` varchar(255) COLLATE latin1_bin DEFAULT NULL,
  `locality` varchar(255) COLLATE latin1_bin DEFAULT NULL,
  `town` varchar(255) COLLATE latin1_bin DEFAULT NULL,
  `postcode` varchar(255) COLLATE latin1_bin DEFAULT NULL,
  `abp_organisation` varchar(255) COLLATE latin1_bin DEFAULT NULL,
  `classification_id` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`id`,`property_id`)
) ENGINE=InnoDB AUTO_INCREMENT=167595 DEFAULT CHARSET=latin1 COLLATE=latin1_bin;
...
CREATE TABLE `address_v2` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `line_1` varchar(255) COLLATE latin1_bin DEFAULT NULL,
  `line_2` varchar(255) COLLATE latin1_bin DEFAULT NULL,
  `line_3` varchar(255) COLLATE latin1_bin DEFAULT NULL,
  `city` varchar(255) COLLATE latin1_bin DEFAULT NULL,
  `county` varchar(255) COLLATE latin1_bin DEFAULT NULL,
  `postcode` varchar(255) COLLATE latin1_bin DEFAULT NULL,
  `location_id` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `idx_addv2_location_id` (`location_id`)
) ENGINE=InnoDB AUTO_INCREMENT=167593 DEFAULT CHARSET=latin1 COLLATE=latin1_bin;
...
CREATE TABLE `location_v2` (
  ...
  `type_code` varchar(50) COLLATE latin1_bin DEFAULT NULL,
  `type_desc` varchar(255) COLLATE latin1_bin DEFAULT NULL,
  `postcode` varchar(10) COLLATE latin1_bin DEFAULT NULL,
  `managing_organization_id` bigint(20) DEFAULT NULL,
  `uprn` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
  `uprn_ralf00` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
  `latitude` double DEFAULT NULL,
  `longitude` double DEFAULT NULL,
  `xcoordinate` double DEFAULT NULL,
  `ycoordinate` double DEFAULT NULL,
  `lsoa_code` varchar(9) COLLATE latin1_bin DEFAULT NULL,
  `msoa_code` varchar(9) COLLATE latin1_bin DEFAULT NULL,
  `imp_code` varchar(9) COLLATE latin1_bin DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `Index_location_id` (`id`),
  KEY `index_managing_organization` (`managing_organization_id`)
) ENGINE=InnoDB AUTO_INCREMENT=167592 DEFAULT CHARSET=latin1 COLLATE=latin1_bin;
...
CREATE TABLE `organization_contact_v2` (
  ...
  `contact_type` varchar(255) COLLATE latin1_bin DEFAULT NULL,
  `value` varchar(255) COLLATE latin1_bin DEFAULT NULL COMMENT 'the actual phone number or email address',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=167591 DEFAULT CHARSET=latin1 COLLATE=latin1_bin;
...
CREATE TABLE `organization_v2` (
  ...
  `ods_code` varchar(50) COLLATE latin1_bin DEFAULT NULL,
  `name` varchar(255) COLLATE latin1_bin DEFAULT NULL,
  `type_code` varchar(50) COLLATE latin1_bin DEFAULT NULL,
  `type_desc` varchar(255) COLLATE latin1_bin DEFAULT NULL,
  `postcode` varchar(10) COLLATE latin1_bin DEFAULT NULL,
...
CREATE TABLE `property_v2` (
  ...
  `project_ralf_id` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`id`,`location_id`),
  KEY `fk_property_location_idx` (`location_id`),
  KEY `fk_project_ralf_idx` (`project_ralf_id`)
) ENGINE=InnoDB AUTO_INCREMENT=167594 DEFAULT CHARSET=latin1 COLLATE=latin1_bin;
...
CREATE TABLE `uprn_match_event_v2` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `uprn` varchar(255) COLLATE latin1_bin DEFAULT NULL,
  `uprn_ralf00` varchar(255) COLLATE latin1_bin DEFAULT NULL,
  `location_id` bigint(20) DEFAULT NULL,
  `patient_address_id` bigint(20) DEFAULT NULL,
  `latitude` double DEFAULT NULL,
  `longitude` double DEFAULT NULL,
  `xcoordinate` double DEFAULT NULL,
  `ycoordinate` double DEFAULT NULL,
  `qualifier` varchar(255) COLLATE latin1_bin DEFAULT NULL,
  `algorithm` varchar(512) COLLATE latin1_bin DEFAULT NULL,
  `match_date` datetime DEFAULT NULL,
  `abp_address_id` bigint(20) DEFAULT NULL,
  `match_pattern_postcode` varchar(255) COLLATE latin1_bin DEFAULT NULL,
  `match_pattern_street` varchar(255) COLLATE latin1_bin DEFAULT NULL,
  `match_pattern_number` varchar(255) COLLATE latin1_bin DEFAULT NULL,
  `match_pattern_building` varchar(255) COLLATE latin1_bin DEFAULT NULL,
  `match_pattern_flat` varchar(255) COLLATE latin1_bin DEFAULT NULL,
  `algorithm_version` varchar(255) COLLATE latin1_bin DEFAULT NULL,
  `epoch` varchar(255) COLLATE latin1_bin DEFAULT NULL,
  `previous_address` varchar(512) COLLATE latin1_bin DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `abp_classification_v2` (
  ...
  `term` varchar(255) COLLATE latin1_bin DEFAULT NULL,
  PRIMARY KEY (`id`,`code`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_bin;
/*!40101 SET character_set_client = @saved_cs_client */;

LOCK TABLES `abp_classification_v2` WRITE;
/*!40000 ALTER TABLE `abp_classification_v2` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `abp_classification_v2` ENABLE KEYS */;
UNLOCK TABLES;
