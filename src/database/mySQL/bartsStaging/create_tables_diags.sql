...
(
    ...
    dt_received                     datetime    NOT NULL COMMENT 'date time this record was received into Discovery',
    record_checksum                 bigint      NOT NULL COMMENT 'checksum of the columns below to easily spot duplicates',
    diagnosis_id                    int         NOT NULL COMMENT 'from diagnosis_id',
...
(
    ...
    diagnosis_code_type  varchar(50) COMMENT 'icd-10 or snomed, derived from CONCEPT_CKI_IDENT. format is: type!code',
    diagnosis_code       varchar(50) COMMENT 'icd-10 or snomed code derived from CONCEPT_CKI_IDENT. format is: type!code',
