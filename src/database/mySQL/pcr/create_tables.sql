...
(
  ...
  entered_by_practitioner_id       int COMMENT 'id in practitioner table. ',
  encounter_id                 bigint,
  encounter_heading_concept_id bigint   NOT NULL COMMENT 'information model concept describing the encounter heading type (e.g. examination, history)',
...
(
  ...
  encounter_id                 bigint COMMENT 'by having this here, we don''t need an encounter_id on the observation, referral, allergy table etc.',
  encounter_heading_concept_id bigint   NOT NULL COMMENT 'information model concept describing the encounter heading type (e.g. examination, history)',
  owning_organisation_id           int COMMENT 'refers to the organisation that owns/manages the event',
