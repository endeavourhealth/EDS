  ...
  BEGIN
    INSERT INTO event_log
      select
        ...
        p.organisation_id,
        now(),
        coalesce(NEW.entered_by_practitioner_id,'-1'),
        0,
        0,
        9,
        NEW.id
  ...
  BEGIN
    INSERT INTO event_log
      select
        ...
        p.organisation_id,
        now(),
        coalesce(OLD.entered_by_practitioner_id,NEW.entered_by_practitioner_id,'-1'),
        0,
        0,
        9,
        OLD.id
  ...
  BEGIN
    INSERT INTO event_log
      select
        ...
        p.organisation_id,
        now(),
        coalesce(OLD.entered_by_practitioner_id,'-1'),
        0,
        1,
        9,
        OLD.id
  ...
  BEGIN
    INSERT INTO event_log
      select
        null,
        o.owning_organisation_id,
        now(),coalesce(OLD.entered_by_practitioner_id,NEW.entered_by_practitioner_id,'-1'),
        0,
        0,
        34,
        OLD.id
  ...
  BEGIN
    INSERT INTO event_log
      select
        null,
        o.owning_organisation_id,
        now(),coalesce(OLD.entered_by_practitioner_id,'-1'),
        0,
        1,
        34,
        OLD.id
