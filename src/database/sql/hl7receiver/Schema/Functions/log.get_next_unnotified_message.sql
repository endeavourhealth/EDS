...
begin
	...
	select 
		...
		m.inbound_payload,
		coalesce(s2.request_message_uiid, uuid_generate_v4()) as request_message_uuid
	from log.message m
	left outer join log.message_notification_status s1 on m.message_id = s1.message_id and s.was_success = true
